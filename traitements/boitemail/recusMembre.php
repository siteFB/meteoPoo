...
<span class="d-flex justify-content-center mt-5">
    ...
    if (isset($_SESSION["user"]) && ($_SESSION["user"]["statut"] == "Membre")) {
        ...
        echo "
        <div>
            <button type='button' class='btn btn-success mx-5'><a class='text-white' href='/templates/espaceMembres/espaceMembre.php'>Retour</a></button>
        </div>
               ";
    } else{
        header('Location: ../../templates/formConnexion.php');
					...
					<div class="col-md-3">
						<div>
							<ul class="nav flex-column mt-5">
                               <li><a href="/traitements/boitemail/ecrireMembre.php" class="btn btn-block btn-primary text-white my-4" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;ÉCRIRE&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
								<li class="mt-3 mb-3"><a class="fs-5" href="/traitements/boitemail/recusMembre.php">Messages (<?php echo $msg_nbr;?>)</a></li>
							</ul>
						</div>
					</div>
    <!----------------------------------------------------------------------------->
