...
include "../../traitements/boitemail/ecrireAdmin.php";
?>
            ...
            <div class="col-10 p-3 mx-auto mb-5 col-lg-3 pb-3 align-self-baseline">
                ...
                <div>
                    <ul class="nav flex-column mt-5">
                        <li><a href="msgEcrireAdmin.php" class="btn btn-block btn-primary text-white mb-2" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;ÉCRIRE&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
