                        ...
                        <div>
                            ...
                            ?>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <p class=" pt-2 px-2"><a class="fs-5 text-secondary text-primary" onclick="return confirm('Voulez-vous supprimer ce message?')" href="/traitements/boitemail/supprMessMembre.php?idUser=<?php echo strip_tags(stripslashes(htmlentities(trim($result['idMessagerie'])))) ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></p>
                                </div>
                            <?php
                            }
                            ?>
